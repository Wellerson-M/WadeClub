            ...
            <tbody>
              ...
              <tr>
                    ...
                    ////Barra de Pesquisa////
                        ...
                        {
                            $data = $_GET['search'];
                            $comando = $pdo->prepare("SELECT * FROM usuario WHERE id_usuario LIKE '%$data%' or nome LIKE '%$data%' or email LIKE '%$data%'");
                    ...
                    ?>
                        ...
                        <td><?php echo $linha['adm_usuario']; ?></td>
                        <td><a href="excluir_usuario.php?id_usuario=<?php echo $linha['id_usuario'];?>" >
