    ...
    <main>
        <nav aria-label="breadcrumb">
            <ol class="mx-5 mt-2 breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="adm_usuarios.php">Usuarios</a></li>
                <li class="breadcrumb-item active" aria-current="page">Info usuario</li>
            </ol>
        </nav>

        <h3 class="text-center">id usuário:
            <?php echo $id_usuario; ?>
        </h3>
        <div class="text-center">
            <a href="excluir_usuario.php?id_usuario=<?php echo $id_usuario?>">
                <button type="button" class='btn btn-danger '>Excluir usuário</button>
            </a>
        </div>
        <div class="container py-2 d-flex text-center">
            ...
            <div class="card mx-2 shadow col">
                <div class="card-header">
                    <h4>Informações endereço:</h4>
                </div>
                <?php
                    $comando = $pdo->prepare("SELECT * FROM endereco WHERE id_usuario = $id_usuario");
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Informações usuário</h5>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="p-2 d-flex justify-content-between">
                                    <label class="fs-5 mx-3 ">Data de nasc: </label>
                                    <input type="text" name="nascimento" class="form-control col"
                                        value="<?php echo $linha['nascimento']; ?>" readonly>
                                </div>
                                <div class="p-2 d-flex justify-content-between">
                                    <label class="fs-5 mx-3 ">Created: </label>
                                    <input type="text" name="created" class="form-control col"
                                        value="<?php echo $linha['created']; ?>" readonly>
                                </div>
                                <div class="p-2 d-flex justify-content-between">
                                    <label class="fs-5 mx-3">Administrador </label>
                                    <select class="form-select border border-primary" name="adm_usuario"
                                        aria-label="Default select example">
                                        <!-- <option selected value="1"> -->
                                        <?php 
                                            $adm = $linha['adm_usuario'];
                                            if ($adm != 0){
                                                ?>
                                        <option value="1">
                                            <?php echo 'Sim'; ?>
                                ...
                                <input class="invisible" name="id_usuario" type="text"
