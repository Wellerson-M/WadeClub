...
<!----  ------->
    ...
    <div class="box-search d-flex justify-content-center py-2">
    ...
    <a href="tela_adm.php" class="d-flex col-1" style="margin-left: 10%; margin-top:-3.5%;">
            ...
            <tbody>
              <tr>
                    ...
                    if (!empty($_GET["search"])) {
                        $data = $_GET["search"];
                        $comando = $pdo->prepare(
                            "SELECT * FROM endereco WHERE id_usuario LIKE '%$data%' or rua LIKE '%$data%' or bairro LIKE '%$data%' or cidade LIKE '%$data%' or estado LIKE '%$data%'"
                        );
                        ...
                        include "listar_enderecos.php";
                    }
                    if (!empty($listaItens)) {
                        foreach ($listaItens as $linha) { ?>
                        <th scope="row"><?php echo $linha["id_usuario"]; ?></th>
                        <td><a style=" color:black;"  href="adm_informacoes.php?id_usuario=<?php echo $linha['id_usuario'];?>"><?php echo $linha["cep"];?></a></td>
                        <td><?php echo $linha["rua"]; ?></td>
                        <td><?php echo $linha["numero"]; ?></td>
                        <td><?php echo $linha["bairro"]; ?></td>
                        <td><?php echo $linha["cidade"]; ?></td>
                        <td><?php echo $linha["estado"]; ?></td>
                        <td><a href="excluir_endereco.php?id_usuario=<?php echo $linha[
                            "id_usuario"
                        ]; ?>" >
                          <button type="button" class="btn btn-outline" data-bs-toggle="tooltip" data-bs-placement="top"  title="Excluir endereço">
